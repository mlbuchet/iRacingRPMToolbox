...
league_sessions = {"season":2, "races":
                [{"race":1, "subsession_id":45043469},
                 ...
                 {"race":10, "subsession_id":46152832},
                 {"race":11, "subsession_id":46276900}]}
...
fd = open("gd_db_dump.json","w")
fd.write(json.dumps(db))
fd.close()
fr = open("gd_races_dump.json","w")
fr.write(json.dumps(data))
fr.close()

fd = open("gd_db_dump.json","r")
db = json.loads(fd.read())
fd.close()
fr = open("gd_races_dump.json","r")
